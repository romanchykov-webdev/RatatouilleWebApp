...
const defaultAvatarOptions: ICompressionOptions = {
...
const defaultRecipeOptions: ICompressionOptions = {
...
export const compressImage = async (
  file: File,
  options: ICompressionOptions = defaultAvatarOptions, // По умолчанию для аватаров
): Promise<CompressedResult> => {
  try {
    const compressionOptions: ICompressionOptions = {
